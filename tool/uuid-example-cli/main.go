...
import (
	"fmt"
	"github.com/potatogopher/goa-uuid-ex/client"
	"github.com/potatogopher/goa-uuid-ex/tool/cli"
...
func main() {
	...
	app := &cobra.Command{
		Use:   "UUID-Example-cli",
		Short: `CLI client for the UUID-Example service`,
	}
	...
	app.PersistentFlags().StringVarP(&c.Host, "host", "H", "http://localhost:8080", "API hostname")
	...
	c.UserAgent = "UUID-Example-cli/0"
